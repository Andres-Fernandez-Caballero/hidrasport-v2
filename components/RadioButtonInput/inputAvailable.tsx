...
const InputAvailable = ({item, name, currentState,onchange}:  InputAvailableProps ) => (
    <label key={item} className="group relative flex items-center justify-center rounded-md border py-3 px-4 text-xs font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6 cursor-pointer bg-white text-gray-900 shadow-sm">
