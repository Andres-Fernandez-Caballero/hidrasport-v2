  ...
  return (
    <section className="container p-4 m-auto">
      ...
      <article className="block rounded-lg bg-white container max-w-screen-lg m-auto border border-gray-700 border-top-2 border-dark-200">
        ...
        <button className="float-right inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wide hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition mr-2">
          Editar <IoPencil />
        </button>
